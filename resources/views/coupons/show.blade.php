										...
										<table class="table table-bordered table-hover table-checkable mt-10" id="kt_datatable">
											<thead>
												<tr>
													...
													<th>{{ __('langs.name') }}</th>
                                                    <th>  {{  __('langs.code') }}</th>
                                                    <th> {{__('langs.discount')}} %</th>
                                                    <th>{{__('langs.status_active')}}</th>
											...
											<tbody>
												...
												<tr>
													...
													<td>{{$coupon->status}}</td>
													<td>
                                                        <a href="{{route('admin.coupon.edit',['id' =>$coupon->id])}}" class="btn btn-sm btn-clean btn-icon" title="{{  __('langs.edit') }}">
                                                            <i class="la la-edit"></i>
                                                        </a>
                                                        <a href="javascript:;" class="btn btn-sm btn-clean btn-icon"
                                                           title="{{  __('langs.delete') }}" data-toggle="modal" data-target="#exampleModalCenter{{$coupon->id}}">
                                                            <i class="la la-trash"></i>
                                                        </a>
                                                        <!-- Modal-->
                                                        <div class="modal fade" id="exampleModalCenter{{$coupon->id}}" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
                                                            <div class="modal-dialog" role="document">
                                                                <div class="modal-content">
																	...
																	{{  __('langs.confirm_msg') }}  {{$coupon->id}} ؟

                                                                    </div>
                                                                    <div class="modal-footer">

                                                                           {!! Form::open(['url' => route('admin.coupon.delete',['id' =>$coupon->id]) , 'files' => true,'method'=>'delete']) !!}
