								...
								<div class="card card-custom">
									<div class="card-header flex-wrap border-0 pt-6 pb-0">
										<div class="card-title">
											<h3 class="card-label"> {{  __('langs.items') }}
										...
										<div class="card-toolbar">
                                            ...
                                            <!--end::Dropdown-->
											<!--begin::Button-->
											<a href="{{url('addItem')}}" class="btn btn-primary font-weight-bolder">
											...
											<tbody>
												...
												<tr>
													...
													<td>
                                                        ...
                                                        <a href="{{route('admin.item.edit',['id' =>$item->id])}}" class="btn btn-sm btn-clean btn-icon" title="{{  __('langs.edit') }}">
                                                            <i class="la la-edit"></i>
                                                        </a>
<!--
                                                        <a href="javascript:;" class="btn btn-sm btn-clean btn-icon" title="{{  __('langs.delete') }}" data-toggle="modal" data-target="#exampleModalCenter{{$item->id}}">
                                                            <i class="la la-trash"></i>
                                                        </a>


                                                        &lt;!&ndash; Modal&ndash;&gt;
                                                        <div class="modal fade" id="exampleModalCenter{{$item->id}}" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
                                                            <div class="modal-dialog" role="document">
                                                                <div class="modal-content">
																	...
																	{{  __('langs.confirm_msg') }}  {{$item->id}} ؟

                                                                    </div>
                                                                    <div class="modal-footer">

                                                                           {!! Form::open(['url' => route('admin.item.delete',['id' =>$item->id]) , 'files' => true,'method'=>'delete']) !!}
