								...
								<div class="card-body">
									...
									<div class="card card-custom gutter-b example example-compact">
										<div class="card-header">
											<h3 class="card-title">   {{  __('langs.edit_item') }}</h3>
											<div class="card-toolbar">
										...
										<!--begin::Form-->
										 {!! Form::open(['url' => route('admin.item.update',['id' => $item->id]),
														'method'=>'post' ,
													...
													<div class="col-lg-6">
														...
														{{  __('langs.title') }}
															  ...
															  @if(app()->isLocale('ar'))
																...
																@endif
														 : </label>
															<input id="title" type="text" class="form-control" required  placeholder=" {{  __('langs.title') }}" name="title"   value="{{$item->title}}" />
													...
													<div class="col-lg-6">
														<label>
															   ...
															   @if(app()->isLocale('ar'))
																...
																@endif
														 : </label>
															<input id="title" type="text" class="form-control" required  placeholder=" {{  __('langs.title') }}" name="title_en"   value="{{$item->title_en}}" />
												...
												<div class="form-group row">
													<div class="col-lg-12">
														...
														: </label>
															...
															<textarea class="form-control" name="description_en"   rows="4">{{$item->description_en}}</textarea>
