									...
									<div class="card-body">
										...
										<div class="card card-custom gutter-b example example-compact">
											<div class="card-header">
												<h3 class="card-title"> {{  __('langs.edit_advert') }}</h3>
												<div class="card-toolbar">
											...
											<!--begin::Form-->
                                             {!! Form::open(['url' => route('admin.advert.update',['id' =>$advert->id]),
                                                            'method'=>'post' ,
													...
													<div class="col-lg-6">
														<label>
															  ...
															  @if(app()->isLocale('ar'))
																...
																@endif
														: </label>
															<input id="title" type="text" class="form-control" required  placeholder=" {{  __('langs.title') }}" name="title"   value="{{ $advert->title }}" />
													...
													<div class="col-lg-6">
														...
														{{  __('langs.title') }}
															   ...
															   @if(app()->isLocale('ar'))
																...
																@endif
														 : </label>
															<input id="title" type="text" class="form-control" required  placeholder=" {{  __('langs.title') }}" name="title_en"   value="{{ $advert->title_en }}" />
												...
												<div class="form-group row">
													<div class="col-lg-12">
														...
														: </label>
															<input id="link" type="text" class="form-control"   name="link"   value="{{ $advert->link }}" />
												...
												<div class="form-group row">
												<label class="col-xl-3 col-lg-3 col-form-label text-right">  {{  __('langs.advert_image') }} </label>
												<div class="col-lg-9 col-xl-6">
													<div class="image-input image-input-outline" id="kt_image_1">
														<!-- <div class="image-input-wrapper"></div> -->
														<div class="image-input-wrapper" style="background-image: url({{asset('image/adverts/'.$advert->img)}})"></div>
