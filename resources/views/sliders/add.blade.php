                        ...
                        <div class="card card-custom">
                            ...
                            <div class="card-body">
                                ...
                                <div class="card card-custom gutter-b example example-compact">
                                    ...
                                    <!--begin::Form-->
                                    {!! Form::open(['url' => route('admin.slider.store'),'method'=>'post' ,'enctype' => 'multipart/form-data',]) !!}
                                    @csrf
                                    <div class="card-body">
                                        <div class="form-group row">
                                            <div class="col-lg-6">
                                                ...
                                                <input id="title" type="text" class="form-control" required placeholder=" {{  __('langs.title') }}" name="title" value="{{ old('title') }}"/>
                                            </div>
                                            <div class="col-lg-6">
                                                <label>{{  __('langs.title') }}
                                                    @if(app()->isLocale('ar'))(إنكليزي)@endif
                                                    @if(app()->isLocale('en'))(en)@endif: </label>
                                                <input id="title" type="text" class="form-control" required placeholder=" {{  __('langs.title') }}" name="title_en" value="{{ old('title_en') }}"/>
                                            </div>
                                        </div>
                                        ...
                                        <div class="sliderList">
                                            <div class="input-group control-group">
                                                <input type="file" name="imageFile" required class="myfrm form-control">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row mt-5">
                                            <div class="col-lg-12">
                                                <label>{{  __('langs.video') }}</label>
                                                    <input id="video" name="video" type="file" class="form-control" required placeholder=" {{  __('langs.video') }}" value="{{ old('video') }}"/>
                                            </div>
                                        </div>
