								...
								<div class="card-body">
									...
									<div class="card card-custom gutter-b example example-compact">
										<div class="card-header">
											<h3 class="card-title">   {{  __('langs.edit_category') }}</h3>
											<div class="card-toolbar">
										...
										<!--begin::Form-->
										 {!! Form::open(['url' => route('admin.category.update',['id' => $category->id]),
														'method'=>'post' ,
													...
													<div class="col-lg-6">
														...
														{{  __('langs.name') }}
															  ...
															  @if(app()->isLocale('ar'))
																...
																@endif
														 : </label>
															<input id="title" type="text" class="form-control" required  placeholder=" {{  __('langs.name') }}" name="name"   value="{{$category->name}}" />
													...
													<div class="col-lg-6">
														<label>
															   ...
															   @if(app()->isLocale('ar'))
																...
																@endif
														 : </label>
															<input id="title" type="text" class="form-control" required  placeholder=" {{  __('langs.car_board_name') }}" name="name_en"   value="{{$category->name_en}}" />
												...
												<div class="form-group row">
													<div class="col-lg-12">
														...
														: </label>
															...
															<textarea class="form-control" name="description_en"   rows="4">{{$category->description_en}}</textarea>
