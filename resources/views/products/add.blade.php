                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-lg-12">
                                                ...
                                                <span
                                                    style="color:#c12a2a;font-size:12px">{{ __('langs.category_msg') }}</span>
                                        ...
                                        <div class="form-group row">
                                            <div class="col-lg-12">
                                                ...
                                                <span
                                                    style="color:#c12a2a;font-size:12px">{{ __('langs.similar_msg') }}</span>
                                                <select class="form-control" name="similars[]" multiple="multiple">
                                                    @foreach($products as $product)
                                                        ...
                                                        @if(app()->isLocale('en'))
                                                            <option
                                                                value="{{  $product->id }}">{{  $product->name_en }}</option>
                                                        @endif
                                                    @endforeach
                                        ...
                                        <div class="form-group row">
                                            <div class="col-lg-6">
                                                ...
                                                <textarea class="form-control" name="product_info" rows="4"></textarea>
                                            </div>
                                            <div class="col-lg-6">
                                                <label>
                                                    {{  __('langs.product_info') }}
