                            ...
                            <div class="card card-custom">
                                <div class="card-header flex-wrap border-0 pt-6 pb-0">
                                    <div class="card-title">
                                        <h3 class="card-label"> {{  __('langs.subscripers') }}
...
{{--                                                    <a href="javascript:;" class="btn btn-sm btn-clean btn-icon" title="{{  __('langs.delete') }}" data-toggle="modal" data-target="#exampleModalCenter{{$subscriper->id}}">--}}
{{--                                                        <i class="la la-trash"></i>--}}
{{--                                                    </a>--}}


{{--                                                    <!-- Modal-->--}}
{{--                                                    <div class="modal fade" id="exampleModalCenter{{$subscriper->id}}" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">--}}
...
{{--                                                                {{  __('langs.confirm_msg') }}  {{$subscriper->id}} ؟--}}

{{--                                                                </div>--}}
{{--                                                                <div class="modal-footer">--}}

{{--                                                                       {!! Form::open(['url' => 'subscriper/'.$subscriper->id , 'files' => true,'method'=>'delete']) !!}--}}
