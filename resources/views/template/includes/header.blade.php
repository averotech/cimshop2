...
@endif
    <head>
        ...
        <title>{{  __('langs.brand') }} </title>
        <link rel="icon" type="image/png" href="http://algheres.net/public/assets/media/logos/logo-letter-13.png"/>
        <link rel="icon" type="image/png" href="http://algheres.net/public/assets/media/logos/logo-letter-13.png">
        <!-- Fonts -->
        ...
        <!--begin::Page Vendors Styles(used by this page)-->
		<link href="{{asset('assets/admin/plugins/custom/datatables/datatables.bundle.rtl.css')}}" rel="stylesheet" type="text/css" />
