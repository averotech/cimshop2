									...
									<div class="card-body">
										...
										<div class="card card-custom gutter-b example example-compact">
											<div class="card-header">
												<h3 class="card-title"> {{  __('langs.add_trolley') }}</h3>
												<div class="card-toolbar">
													...
													<div class="col-lg-6">
														<label>
															  ...
															  @if(app()->isLocale('ar'))
																...
																@endif
														: </label>
															<input id="title" type="text" class="form-control" required  placeholder=" {{  __('langs.car_board_name') }}" name="name"   value="{{ old('name') }}" />
													...
													<div class="col-lg-6">
														...
														{{  __('langs.car_board_name') }}
															   ...
															   @if(app()->isLocale('ar'))
																...
																@endif
														 : </label>
															<input id="title" type="text" class="form-control" required  placeholder=" {{  __('langs.car_board_name') }}" name="name_en"   value="{{ old('name_en') }}" />
														<span class="form-text text-muted">{{  __('langs.car_board_name_msg') }} </span>
												...
												<div class="form-group row">
													...
													<div class="form-group col-lg-12">
														...
														<select class="form-control" id="exampleSelectd" name="type">
															<option value="unloading" > {{  __('langs.unloading') }}</option>
															<option value="work_dormitory" > {{  __('langs.work_dormitory') }}</option>
															<option value="customer_delivery"  > {{  __('langs.customer_delivery') }}</option>
														</select>
													</div>
												</div>
