									...
									<div class="card-body">
										...
										<div class="card card-custom gutter-b example example-compact">
											<div class="card-header">
												<h3 class="card-title"> {{  __('langs.add_category') }}</h3>
												<div class="card-toolbar">
											...
											<!--begin::Form-->
                                             {!! Form::open(['url' => route('admin.size.store'),
                                                            'method'=>'post' ,
													...
													<div class="col-lg-6">
														<label>
															  ...
															  @if(app()->isLocale('ar'))
																...
																@endif
														: </label>
															<input id="title" type="text" class="form-control" required  placeholder=" {{  __('langs.name') }}" name="name"   value="{{ old('name') }}" />
													...
													<div class="col-lg-6">
														...
														{{  __('langs.name') }}
															   ...
															   @if(app()->isLocale('ar'))
																...
																@endif
														 : </label>
															<input id="title" type="text" class="form-control" required  placeholder=" {{  __('langs.name') }}" name="name_en"   value="{{ old('name_en') }}" />
