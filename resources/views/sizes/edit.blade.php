								...
								<div class="card-body">
									...
									<div class="card card-custom gutter-b example example-compact">
										<div class="card-header">
											<h3 class="card-title">   {{  __('langs.edit_size') }}</h3>
											<div class="card-toolbar">
										...
										<!--begin::Form-->
										 {!! Form::open(['url' => route('admin.size.update',['id' => $size->id]),
														'method'=>'post' ,
													...
													<div class="col-lg-6">
														...
														{{  __('langs.name') }}
															  ...
															  @if(app()->isLocale('ar'))
																...
																@endif
														 : </label>
															<input id="title" type="text" class="form-control" required  placeholder=" {{  __('langs.name') }}" name="name"   value="{{$size->name}}" />
													...
													<div class="col-lg-6">
														<label>
															   ...
															   @if(app()->isLocale('ar'))
																...
																@endif
														 : </label>
															<input id="title" type="text" class="form-control" required  placeholder=" {{  __('langs.car_board_name') }}" name="name_en"   value="{{$size->name_en}}" />
