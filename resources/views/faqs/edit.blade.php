								...
								<div class="card-body">
									...
									<div class="card card-custom gutter-b example example-compact">
										<div class="card-header">
											<h3 class="card-title">   {{  __('langs.edit_faq') }}</h3>
											<div class="card-toolbar">
										...
										<!--begin::Form-->
										 {!! Form::open(['url' =>  route('admin.faq.update',['id' =>$faq->id]),
														'method'=>'post' ,
											...
											<div class="form-group row">
													<div class="col-lg-12">
														...
														: </label>
															...
															<textarea class="form-control" name="question"   rows="1">{{$faq->question}}</textarea>
												...
												<div class="form-group row">
													<div class="col-lg-12">
														...
														: </label>
															...
															<textarea class="form-control" name="question_en"   rows="1">{{$faq->question_en}}</textarea>
												...
												<div class="form-group row">
													<div class="col-lg-12">
														...
														: </label>
															...
															<textarea class="form-control" name="answer"   rows="4">{{$faq->answer}}</textarea>
												...
												<div class="form-group row">
													<div class="col-lg-12">
														...
														: </label>
															...
															<textarea class="form-control" name="answer_en"   rows="4">{{$faq->answer_en}}</textarea>
