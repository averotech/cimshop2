								...
								<div class="card card-custom">
									<div class="card-header flex-wrap border-0 pt-6 pb-0">
										<div class="card-title">
											<h3 class="card-label"> {{  __('langs.faq') }}
											...
											<tbody>
												...
												<tr>
													...
													<td>
                                                        ...
                                                        <a href="{{route('admin.faq.edit',['id' =>$faq->id])}}" class="btn btn-sm btn-clean btn-icon" title="{{  __('langs.edit') }}">
                                                            <i class="la la-edit"></i>
                                                        </a>
                                                        <a href="javascript:;" class="btn btn-sm btn-clean btn-icon"
                                                           title="{{  __('langs.delete') }}" data-toggle="modal" data-target="#exampleModalCenter{{$faq->id}}">
                                                            <i class="la la-trash"></i>
                                                        </a>


                                                        <!-- Modal-->
                                                        <div class="modal fade" id="exampleModalCenter{{$faq->id}}" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
                                                            <div class="modal-dialog" role="document">
                                                                <div class="modal-content">
																	...
																	{{  __('langs.confirm_msg') }}  {{$faq->id}} ؟

                                                                    </div>
                                                                    <div class="modal-footer">

                                                                           {!! Form::open(['url' => route('admin.faq.delete',['id' =>$faq->id]) , 'files' => true,'method'=>'delete']) !!}
